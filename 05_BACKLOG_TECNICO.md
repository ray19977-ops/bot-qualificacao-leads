...
| TEST-04 | Caso de teste: loop sem progresso | Executar o diálogo do Caso 4, com respostas "não sei" repetidas | Bot não repete a pergunta pela 4ª vez; encerra graciosamente pedindo contato (CONV-13) | todos CONV | reprovado — 2 falhas: (1) gatilho CONV-13 não dispara entre campos: a desambiguação (CONV-12) absorve cada "não sei" e avança de campo, levando 7 mensagens sem progresso até encerrar (vs. 3 do Caso 4); (2) encerramento por loop veio sem o marcador [FIM_QUALIFICACAO] e o resumo estruturado não foi gerado (viola system_prompt, situação 3 do marcador). Correção será item novo de backlog após o lote TEST-02/04/06/07 |
